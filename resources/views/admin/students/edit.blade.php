        ...
        <div class="col-lg-8 mx-auto">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-warning text-white">
                    <h5 class="mb-0">
                        <i class="fas fa-user-edit me-2"></i>Sửa Sinh viên: {{ $student->first_name }} {{ $student->last_name }}
                    </h5>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="faculty_id" id="faculty_id" class="form-select @error('faculty_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($faculties as $f)
                                        <option value="{{ $f->id }}" {{ old('faculty_id', $student->faculty_id) == $f->id ? 'selected' : '' }}>
                                            {{ $f->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="class_id" id="class_id" class="form-select @error('class_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($classes as $c)
                                        <option value="{{ $c->id }}" data-faculty="{{ $c->faculty_id }}" {{ old('class_id', $student->class_id) == $c->id ? 'selected' : '' }}>
                                            {{ $c->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="academic_year" class="form-control @error('academic_year') is-invalid @enderror"
                                       placeholder="VD: 2023-2024" value="{{ old('academic_year', $student->academic_year) }}">
                                @error('academic_year')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="degree_type" class="form-control @error('degree_type') is-invalid @enderror"
                                       value="{{ old('degree_type', $student->degree_type) }}">
                                @error('degree_type')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                @if($student->photo)
                                    <div class="mt-2">
                                        <img src="{{ asset('storage/' . $student->photo) }}" alt="Student Photo" style="max-width: 150px; border-radius: 8px;">
                                    </div>
                                @endif
                                @error('photo')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                    ...
                                    <option value="inactive" {{ old('status', $student->status) === 'inactive' ? 'selected' : '' }}>Bị khoá</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
